...
exports.routes = {
  get: [
    { path: '/players/:id', action: 'playerGet' }, // (GET) /api/players
    { path: '/player/:playerId/gameprofiles/:id', action: 'gameprofileGet' }, // (GET) /api/players/1234/gameprofiles
    { path: '/player/:playerId/gameprofiles', action: 'gameprofileGetAll' }, // (GET) /api/players/1234/gameprofiles
    //{ path: '/search/:term/limit/:limit/offset/:offset', action: 'search' }, // (GET) /api/search/car/limit/10/offset/100
  ],
